# Scalable-Web-App-Using-Azure-App-Services-Azure-SQL-Storage
Skills demonstrated: App Service deployment, connection strings, Azure SQL, Storage Accounts, RBAC
